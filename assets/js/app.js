...
/**
 * Toggle search view on mobile devices
 */
...
export const updateWeather = function (lat, lon) {
    ...
    fetchData(url.currentWeather(lat, lon), function (currentWeather) {
        ...
        fetchData(url.forecast(lat, lon), function (forecast) {
            ...
            forecastList.slice(7).forEach((data, i) => {
                if (i % 8 !== 0) return; // Ensure we pick one item per day
                ...
                const temp_max = data.main.temp_max; // Add temp_max if not included
